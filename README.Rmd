...
[![CaviR badge](https://img.shields.io/badge/CaviR-ready%20to%20use-brightgreen)](https://github.com/Watjoa/CaviR)
...
To generate an overview of all important diagnostics for a linear model, ```coRtable``` can be used. 
