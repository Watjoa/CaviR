...
#'
#' @param variables a vector of your variables
#' @param group a character of the name of your group variable
#' @param dataset name of the dataset
#' @return MANOVA table with descriptives and statistics
#' @export
...
manovaR<- function(variables,group,dataset) { # input is a dataset (x) that includes a grouping variable (group)
  ...
  table35 <- plyr::ddply(table35,levels(groupmanova))
